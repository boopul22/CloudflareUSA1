...
How to Opt-Out: To exercise this right, please visit our [Opt-Out Form Link] or email us at help@autoclaimfiling.online with the subject line "Opt-Out Request."
...
10. CONTACT US
To exercise your privacy rights or opt-out, please contact: Email: help@autoclaimfiling.online Address: [Insert Physical Address]
...
How to Exercise Your Rights: Please submit your request to help@autoclaimfiling.online with the subject line "Washington Privacy Request."
6. Appeals Process
If we deny your request to exercise a right under the MHMDA, you have the right to appeal our decision within 30 days.
To appeal, please email help@autoclaimfiling.online with the subject line “Privacy Appeal.”
...
16. ADA Compliance
We are committed to accessibility. If you have difficulty navigating our content, please contact us at help@autoclaimfiling.online.
17. Contact Us
Auto File Claim [Insert Address] help@autoclaimfiling.online [Insert Phone Number]
...
Email: help@autoclaimfiling.online
5. AUTHORIZED AGENTS
If you are submitting this request on behalf of another person, you must provide written proof of your authority (such as a power of attorney) to help@autoclaimfiling.online before we can process the request.



Internal Action Plan (For your Team)
Suppression: When this form is submitted, the Email and Phone should be sent to a "Global Suppression List" that prevents them from being exported to law firms or uploaded to your dialer.
Confirmation: Send a follow-up email to the user: "We have received your request to opt-out. Your information has been added to our suppression list, and we will no longer share your data with marketing partners."

The CPRA (California) requires you to notify third parties to whom you have sold or shared personal information at the time of the request.
...
API Webhook: Your website should send a webhook to your dialer (e.g., RingCentral, Vicidial, etc.) to move that phone number to a "Global DNC" (Do Not Call) list.
Lead Export Block: Before any lead is exported to a law firm, your script must check the email/phone against the Suppression List. If a match exists, the export must be aborted.
Log Entry: Keep a "Privacy Request Log" showing the Timestamp and IP Address of the opt-out. This is your "Receipt" if a partner accidentally calls them and you need to prove it wasn't your fault.
...
DNC Tag: Apply a DO_NOT_CONTACT tag to the record in your CRM.
Scrubbing: If you have any "Scheduled" SMS or follow-up emails, the system must immediately cancel them for that specific Lead ID.
