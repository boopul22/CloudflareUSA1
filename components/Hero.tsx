        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in-up">
            ...
            <div className="mt-8 flex items-center justify-center lg:justify-start gap-4 text-sm text-gray-500">
              <div className="flex -space-x-2">
                {[1,2,3,4].map(i => (
                  <img key={i} src={`https://picsum.photos/seed/user${i}/40`} alt="User" className="w-8 h-8 rounded-full border-2 border-white" />
                ))}
              </div>
          ...
          <div className="relative mt-4 lg:mt-0">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white transform hover:scale-[1.01] transition-transform duration-500">
              <img 
                src="https://picsum.photos/seed/caraccident/800/600" 
