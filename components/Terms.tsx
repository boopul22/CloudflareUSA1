      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        ...
        <div className="prose prose-lg max-w-none text-gray-600 space-y-10">
          ...
          <section id="ada">
            ...
            <p className="leading-relaxed">
              We are committed to accessibility. If you have difficulty navigating our content, please contact us at <a href="mailto:access@autofileclaim.com" className="text-brand-primary hover:underline">access@autofileclaim.com</a>.
            </p>
          </section>
