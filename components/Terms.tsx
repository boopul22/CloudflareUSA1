    ...
    <div className="pt-24 min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-5xl font-bold text-brand-dark mb-4">TERMS OF USE</h1>
        ...
        <div className="prose prose-lg max-w-none text-gray-600 space-y-10">
          ...
          <section id="services">
            <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-4">2. Marketing and Administrative Services</h2>
          ...
          <section id="changes">
            <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-4">3. Changes to these Terms</h2>
            <p className="leading-relaxed">
          ...
          <section id="tcpa">
            <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-4">4. Consent to Electronic & Telephone Communications (TCPA)</h2>
          ...
          <section id="prohibited">
            <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-4">5. Prohibited Conduct</h2>
          ...
          <section id="submitted">
            <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-4">6. Submitted Materials</h2>
            <p className="leading-relaxed">
          ...
          <section id="intellectual">
            <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-4">7. Intellectual Property</h2>
            <p className="leading-relaxed">
          ...
          <section id="third-party">
            <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-4">8. Third-Party Websites</h2>
            <p className="leading-relaxed">
          ...
          <section id="disclaimers">
            <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-4">10. Disclaimers</h2>
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-5">
              <p className="leading-relaxed font-bold text-yellow-900 uppercase">
          ...
          <section id="liability">
            <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-4">11. Limitation of Liability</h2>
            <div className="bg-gray-100 border border-gray-200 rounded-lg p-5">
              <p className="leading-relaxed font-bold text-gray-900 uppercase">
          ...
          <section id="security">
            <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-4">12. Security & Data Breach</h2>
            <p className="leading-relaxed">
          ...
          <section id="termination">
            <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-4">13. Termination</h2>
            <p className="leading-relaxed">
          ...
          <section id="law-venue">
            <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-4">14. Applicable Law & Venue</h2>
            <p className="leading-relaxed">
          ...
          <section id="dispute">
            <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-4">15. Dispute Resolution; Class Action & Jury Trial Waiver</h2>
          ...
          <section id="ada">
            ...
            <p className="leading-relaxed">
              We are committed to accessibility. If you have difficulty navigating our content, please contact us at <a href="mailto:immaculatemedia2018@gmail.com" className="text-brand-primary hover:underline">immaculatemedia2018@gmail.com</a>.
            </p>
          </section>
