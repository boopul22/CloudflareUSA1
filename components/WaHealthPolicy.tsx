                ...
                <div className="prose prose-lg max-w-none text-gray-600 space-y-10">
                    ...
                    <section>
                        ...
                        <div className="bg-brand-primary/5 border border-brand-primary/20 rounded-lg p-5 mt-6">
                            <p className="leading-relaxed">
                                <strong>How to Exercise Your Rights:</strong> Please submit your request to <a href="mailto:privacy@autofileclaim.com" className="text-brand-primary hover:underline">privacy@autofileclaim.com</a> with the subject line "Washington Privacy Request."
                            </p>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-6 space-y-2">
                            <li>To appeal, please email <a href="mailto:privacy@autofileclaim.com" className="text-brand-primary hover:underline">privacy@autofileclaim.com</a> with the subject line “Privacy Appeal.”</li>
