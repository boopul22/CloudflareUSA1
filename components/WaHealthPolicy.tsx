...
export const WaHealthPolicy: React.FC = () => {
        ...
        <div className="pt-24 min-h-screen bg-white">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
                <div className="text-center mb-12">
                    <h1 className="text-3xl md:text-5xl font-bold text-brand-dark mb-4">WASHINGTON CONSUMER HEALTH DATA POLICY</h1>
                ...
                <div className="prose prose-lg max-w-none text-gray-600 space-y-10">
                    ...
                    <section>
                        <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-4">1. Categories of Health Data Collected</h2>
                    ...
                    <section>
                        <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-4">2. Sources of Collection</h2>
                    ...
                    <section>
                        <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-4">3. Purpose of Collection and Use</h2>
                    ...
                    <section>
                        <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-4">4. Sharing of Health Data</h2>
                        ...
                        <ul className="list-disc pl-6 space-y-2">
                            ...
                            <li><strong>Affiliates:</strong> A list of the categories of third parties with whom we share data can be found on our Sponsors/Partners Page.</li>
                        </ul>
                    </section>

                    <section>
                        <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-4">5. Your Rights and How to Exercise Them</h2>
                        ...
                        <div className="bg-brand-primary/5 border border-brand-primary/20 rounded-lg p-5 mt-6">
                            <p className="leading-relaxed">
                                <strong>How to Exercise Your Rights:</strong> Please submit your request to <a href="mailto:immaculatemedia2018@gmail.com" className="text-brand-primary hover:underline">immaculatemedia2018@gmail.com</a> with the subject line "Washington Privacy Request."
                            </p>
                        </div>
                    </section>

                    <section>
                        <h2 className="text-xl md:text-2xl font-bold text-brand-dark mb-4">6. Appeals Process</h2>
                        <p className="mb-4">
                            If we deny your request to exercise a right under the MHMDA, you have the right to appeal our decision within 30 days.
                        </p>
                        <ul className="list-disc pl-6 space-y-2">
                            <li>To appeal, please email <a href="mailto:immaculatemedia2018@gmail.com" className="text-brand-primary hover:underline">immaculatemedia2018@gmail.com</a> with the subject line “Privacy Appeal.”</li>
