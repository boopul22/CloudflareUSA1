...
export const PrivacyChoices: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const emailResponse = await fetch('https://formsubmit.co/ajax/immaculatemedia2018@gmail.com', {
                method: 'POST',
                headers: {
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
                ...
                <div className="prose prose-lg max-w-none text-gray-600 space-y-8">
                    ...
                    <section>
                        ...
                        <p><strong>Email:</strong> <a href="mailto:immaculatemedia2018@gmail.com" className="text-brand-primary hover:underline">immaculatemedia2018@gmail.com</a></p>
                    </section>

                    <section>
                        <h2 className="text-xl font-bold text-brand-dark mb-4">5. AUTHORIZED AGENTS</h2>
                        <p>
                            If you are submitting this request on behalf of another person, you must provide written proof of your authority (such as a power of attorney) to <a href="mailto:immaculatemedia2018@gmail.com" className="text-brand-primary hover:underline">immaculatemedia2018@gmail.com</a> before we can process the request.
                        </p>
                    </section>
