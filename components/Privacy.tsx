        ...
        <div className="prose prose-lg max-w-none text-gray-600 space-y-10">
          ...
          <section id="california-colorado">
            ...
            <div className="bg-brand-primary/5 border border-brand-primary/20 rounded-lg p-5">
              <p className="leading-relaxed">
                <strong>How to Opt-Out:</strong> To exercise this right, please visit our <a href="#privacy-choices" className="text-brand-primary hover:underline">Your Privacy Choices</a> page or email us at <a href="mailto:immaculatemedia2018@gmail.com" className="text-brand-primary hover:underline">immaculatemedia2018@gmail.com</a> with the subject line "Opt-Out Request."
              </p>
            </div>
          </section>
