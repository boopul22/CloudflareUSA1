      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="space-y-6">
            <div className="flex items-center cursor-pointer" onClick={() => window.location.hash = ''}>
                ...
                <span className="font-bold text-2xl text-white tracking-tight">Auto File Claim</span>
            </div>
            ...
            <ul className="space-y-6">
              ...
              <li className="flex items-start gap-4 group">
                ...
                <div>
                    ...
                    <a href="mailto:info@auto-file-claim.com" className="text-white font-medium hover:text-brand-primary transition-colors cursor-pointer break-all">info@auto-file-claim.com</a>
                </div>
              </li>
              <li className="flex items-start gap-4 group">
                 <div className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center shrink-0 group-hover:bg-brand-primary/20 transition-colors">
        ...
        <div className="space-y-8">
           ...
           <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-600">
             <p>&copy; 2025 Auto File Claim. All rights reserved.</p>
